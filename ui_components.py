...
def setup_ui(window):
    window.setStyleSheet(
        "QWidget { background-color: #4DA6FF; }"
        "QPushButton { background-color: #80C1FF; color: black; border-radius: 4px; }"
        "QLineEdit { background-color: #CCE6FF; color: black; border-radius: 4px; }"
        "QLabel { background-color: #4DA6FF; color: black; font-size: 16px; font-weight: bold; border-radius: 4px; }"
        "QComboBox, QListWidget { background-color: #CCE6FF; color: black; border-radius: 4px; }"
        "QHeaderView::section { background-color: #0066CC; color: black; font-size: 16px; border-radius: 4px; }"
    )
